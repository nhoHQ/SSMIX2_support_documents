...
* 日本医療情報学会発行の「SS-MIX2標準化ストレージ構成の説明と構築ガイドラインVer.1.2d」、「SS-MIX2拡張ストレージ構成の説明と構築ガイドラインVer.1.2d」、「SS-MIX2標準化ストレージ仕様書Ver.1.2」及び「標準化ストレージ仕様書別紙：コード表Ver.1.2d」に記載している仕様に対応していること。（尚、当初V1.2c準拠としていたが、標準ストレージ部分では1.2cからの変更点について影響がないためV1.2d準拠ということとした。）
