...
|($1)g/dL|($2)mmol/L|($2)=($1)\*0.62|JLAC10が3H080000001927058(血液ガスのヘモグロビン)の場合、計算式を適用する|
|($1)mg/dl|($2)mmol/L|($2)=($1)\*0.05551|JLAC10が3H080000001927085(血液ガスのGlucose)の場合、計算式を適用する|
|($1)mEq/L|($2)mmol/L|($2)=($1)|JLAC10が3H080000001927081、3H080000001927082、3H080000001927083(血液ガスのNa+、K+、Cl-)の場合、計算式を適用する|
|($1)mEq/L|($2)mmol/L|($2)=($1)\*2|JLAC10が3H080000001927084(血液ガスのCa++)の場合、計算式を適用する|
